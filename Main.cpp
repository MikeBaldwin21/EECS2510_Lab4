...
void RunLoopInsert()
{
	...
	double  RBTtime = ((double)(clock() - (double)start)) / CLOCKS_PER_SEC;
	...
	cout << "RBT Work[" << bTree.GetApproxWorkDone() << "] - Time[" << RBTtime << "] - U-Nodes[" << bTree.GetUnique() << "] - NU-Nodes[" << bTree.GetNonUnique() << "]" << endl;
